                ...
                <div className="w-full">
                    <div
                        ...
                        <div className="md:w-1/2 bg-slate-900 relative order-1 md:order-2 min-h-80 overflow-hidden">
                            ...
                            <div className="w-full h-full bg-cover bg-center transform group-hover:scale-105 transition-transform duration-700 ease-in-out bg-[url('https://lh3.googleusercontent.com/aida-public/AB6AXuAp5LJpyw3iz8DlZ2L5E6M_b3fxlFQ64_0NpNXHQmDud81bxdb3CsEGQPjGsO-fC_Pwh72o68OR5w1NCFwpW1cJ2m95jYTMY5tUmKomgFLStuWuuvCzbE28Fm4hOAfXKZNRiKX5B87UoGkoYz37BjUcA5iljfym8C-HCRtBukyLQWwz-S99cqspLEX_jr3GLd2D-9q6SuCNiTXZGd6qf4U94FsWyM9k3OI1hG45zyLQB5cdhkAV5adLacrRboqrMumwA5s8BcEG8Acn')]">
                            </div>
                        </div>
                    </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div
                        ...
                        <div className="relative h-56 overflow-hidden">
                            ...
                            <div className="w-full h-full bg-cover bg-center transform group-hover:scale-105 transition-transform duration-500 bg-[url('https://lh3.googleusercontent.com/aida-public/AB6AXuCtioZY23N8_pevNafrNF5Fw1z_q_zXSpZdn1Rf0O4asyFi9DCWJB5DiCSsH9cVnNDL-sN8GRePRgUivs7w7ntE0iqCDDxRXUI-X_0lqayRJx9wPtLkq-HNPBMjKg6Zt3yF5PXZg7BvlSccf6suvtdt6rCOYQcr4_-Nh_JgBemaA-4xVGWLXwjssjIfpUxUmQhHll5iyX9J2zpbMKwJBVV0fEe2aLrTqyJfldYk8Zii7gfkPUIMjZFZOA_83MTu360EpqqpZBZ3AWjL')]">
                            </div>
                    ...
                    <div
                        ...
                        <div className="relative h-56 overflow-hidden">
                            ...
                            <div className="w-full h-full bg-cover bg-center transform group-hover:scale-105 transition-transform duration-500 bg-[url('https://lh3.googleusercontent.com/aida-public/AB6AXuCGQWImCp0L7lErwaxNRWAFgtWmYWXz6zKrmngqrDTCImh2yPaOkt28wZuWMRlkamgxctWTfLLjPVik9UAt2ZMK0DPeIbxtOfxK5X5RkGrkjwDuyzMIv9_dOES4HuWvzL_9fJBVyeHZENzqs3FYcX11imL__sh8aELNU0iJMrurRQQIEOP1ZYozivpIzTUdPIr-aPvVZV0i5tJboLF3LeouDnz7LsMdL9ZcBy91L9OA9ycVobrHf0DyHMEIincTQYeINBGFJwV-KjWc')]"></div>
                            <div className="absolute inset-0 bg-linear-to-t from-black/50 to-transparent opacity-40"></div>
                        </div>
                        <div className="flex flex-col flex-1 p-6 gap-4">
                            <div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div className="absolute inset-0 opacity-30  bg-[radial-gradient(#94a3b8_1px,transparent_1px)] bg-size-[16px_16px]"></div>
                            <span
                    ...
                    <div
                        ...
                        <div className="relative h-56 overflow-hidden">
                            ...
                            <div className="w-full h-full bg-cover bg-center transform group-hover:scale-105 transition-transform duration-500 bg-[url('https://lh3.googleusercontent.com/aida-public/AB6AXuCypWURj9IUGMfiENVyOQxitWn23Asp7RofGs3KIuPWwfVm4nJoytN5YdLKCHVvfHxQwwaxNGW-x7DciHZdRKlFRoZwH6A6p7Udm1B5xqN86bgDKyhhYPcUUytNXOVo0UUkkSpxGxJUUpqG09m73bv5JjUYjsJnZiIB44Gn5vim37ZWMAH6wZyzfInQYWp8uJRkyLIzX9M5RKZRUQRo1NT31VL7TfVMCKvbO-WGg9lam65AGjovudDy8Ec6_s9s1SUsLLgn7g95XRXw')]">
                            </div> 
                        </div>
                        <div className="flex flex-col flex-1 p-6 gap-4">
                            <div>
